	...
	args = {
		...
		desc = { -- one here to display version info and author. 
			...
			name = L( "Version: {1}", -- widget with.
			       ...
			       .. "|n" .. L["Original Project by Tammya-MoonGuard,"]
				.. "|n" .. L["ES Redux by VfX for continued development and maintenance,"];
			type = "description";
		};
		-----------------------------------------------------------------------
		...
		-----------------------------------------------------------------------
		-- Button to reset both marks to the default » character, in case
		-- they were accidentally cleared.
		resetmarks = {
...
function Me.Options_Init()
	...
	-- In 12.0, Settings.OpenToCategory requires the category object that
	-- Settings.RegisterCanvasLayoutCategory returns. AceConfigDialog calls
	-- that function internally during AddToBlizOptions. We briefly wrap it
	-- to capture the category object before anything reassigns its ID.
